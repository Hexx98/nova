...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("interactions", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
    ...
    op.create_table(
        ...
        sa.Column("phase_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("phases.id"), nullable=False),
        sa.Column("achieved_objectives", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
        sa.Column(
            "business_impact",
        ...
        sa.Column("remediation_plan", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
