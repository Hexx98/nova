...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("auth_config", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_object()")),
        sa.Column("seed_urls", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
        sa.Column("include_patterns", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
        sa.Column("exclude_patterns", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
        ...
        sa.Column("custom_headers", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_object()")),
        sa.Column(
            "status",
        ...
        sa.Column("discovered_urls", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_array()")),
        sa.Column("crawl_stats", postgresql.JSONB, nullable=False, server_default=sa.text("jsonb_build_object()")),
